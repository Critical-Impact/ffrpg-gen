...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MonsterAttackModifier.monsterAttack'
        db.add_column('main_monsterattackmodifier', 'monsterAttack',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.MonsterAttack'], null=True),
                      keep_default=False)


        # Changing field 'MonsterAttackModifier.modifier'
        db.alter_column('main_monsterattackmodifier', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BaseMonsterAttackModifier'], on_delete=models.SET_NULL, null=True))
        # Removing M2M table for field modifiers on 'MonsterAttack'
        db.delete_table(db.shorten_name('main_monsterattack_modifiers'))


    def backwards(self, orm):
        # Deleting field 'MonsterAttackModifier.monsterAttack'
        db.delete_column('main_monsterattackmodifier', 'monsterAttack_id')


        # Changing field 'MonsterAttackModifier.modifier'
        db.alter_column('main_monsterattackmodifier', 'modifier_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BaseMonsterAttackModifier'], null=True))
    ...
    models = {
        ...
        'main.character': {
            ...
            'accessorySlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedAccessories'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'accessorySlot2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedAccessories2'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'bodySlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedBodies'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'characterImage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.ImageFile']", 'related_name': "'characterImages'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'handSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedHands'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'headSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedHeads'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']", 'related_name': "'characters'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Race']", 'related_name': "'characters'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'reaction': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'secondWeaponSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedSecondaryWeapons'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'related_name': "'characters'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
            'vitality': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'max_length': '3', 'null': 'True'}),
            'weaponSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedWeapons'", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
        ...
        'main.monsterattackmodifier': {
            ...
            'monsterAttack': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.MonsterAttack']", 'null': 'True'}),
