...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.job2'
        db.add_column('main_character', 'job2',
                      self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.SET_NULL, to=orm['main.Job'], null=True, related_name='characters2'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.job2'
        db.delete_column('main_character', 'job2_id')
    ...
    models = {
        ...
        'main.character': {
            ...
            'job2': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.SET_NULL', 'to': "orm['main.Job']", 'null': 'True', 'related_name': "'characters2'"}),
        ...
        'main.monsterattackmodifier': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modifier': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.SET_NULL', 'to': "orm['main.BaseMonsterAttackModifier']", 'null': 'True'}),
            'monsterAttack': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.MonsterAttack']", 'null': 'True', 'related_name': "'modifiers'"}),
            'option': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '255'}),
            'option2': ('django.db.models.fields.CharField', [], {'blank': 'True', 'null': 'True', 'max_length': '255'})
        },
        'main.overviewbox': {
