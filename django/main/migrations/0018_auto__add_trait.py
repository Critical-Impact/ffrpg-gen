...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_trait', (
            ...
            ('traitType', self.gf('django.db.models.fields.IntegerField')()),
            ('cost', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('main', ['Trait'])

        # Adding M2M table for field traits on 'Character'
        m2m_table_name = db.shorten_name('main_character_traits')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('character', models.ForeignKey(orm['main.character'], null=False)),
            ('trait', models.ForeignKey(orm['main.trait'], null=False))
        ))
        db.create_unique(m2m_table_name, ['character_id', 'trait_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field traits on 'Character'
        db.delete_table(db.shorten_name('main_character_traits'))
