...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Job.expertiseSkill'
        db.add_column('main_job', 'expertiseSkill',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Skill'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Job.expertiseAttribute'
        db.add_column('main_job', 'expertiseAttribute',
                      self.gf('django.db.models.fields.CharField')(max_length=20, blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Job.expertiseSkill'
        db.delete_column('main_job', 'expertiseSkill_id')

        # Deleting field 'Job.expertiseAttribute'
        db.delete_column('main_job', 'expertiseAttribute')
    ...
    models = {
        ...
        'main.job': {
            ...
            'expertiseSkill': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Skill']", 'null': 'True', 'blank': 'True'}),
