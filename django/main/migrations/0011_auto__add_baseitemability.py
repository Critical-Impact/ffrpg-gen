...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BaseItemAbility'
        db.create_table('main_baseitemability', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('baseItem', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BaseItem'])),
        ))
        db.send_create_signal('main', ['BaseItemAbility'])


    def backwards(self, orm):
        # Deleting model 'BaseItemAbility'
        db.delete_table('main_baseitemability')
    ...
    models = {
        ...
        'main.baseitem': {
            ...
            'armourCategory': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['main.ArmourCategory']", 'null': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'itemType': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'max_length': '2', 'null': 'True'}),
            ...
            'weaponCategory': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'to': "orm['main.WeaponCategory']", 'null': 'True'})
        },
