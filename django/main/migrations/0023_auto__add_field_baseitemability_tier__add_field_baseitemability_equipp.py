...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseItemAbility.tier'
        db.add_column('main_baseitemability', 'tier',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)

        # Adding field 'BaseItemAbility.equippableTo'
        db.add_column('main_baseitemability', 'equippableTo',
                      self.gf('django.db.models.fields.IntegerField')(blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseItemAbility.tier'
        db.delete_column('main_baseitemability', 'tier')

        # Deleting field 'BaseItemAbility.equippableTo'
        db.delete_column('main_baseitemability', 'equippableTo')
