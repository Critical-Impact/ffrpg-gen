...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemCategory.craftPoints'
        db.add_column('main_itemcategory', 'craftPoints',
                      self.gf('django.db.models.fields.IntegerField')(null=True, max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemCategory.craftPoints'
        db.delete_column('main_itemcategory', 'craftPoints')
    ...
    models = {
        ...
        'main.character': {
            ...
            'characterImage': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'to': "orm['main.ImageFile']", 'related_name': "'characterImages'"}),
