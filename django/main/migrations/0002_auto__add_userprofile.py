...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('main_userprofile', (
            ...
            ('currentCharacter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Character'])),
        ))
    ...
    models = {
        ...
        'main.userprofile': {
            ...
            'currentCharacter': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Character']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
