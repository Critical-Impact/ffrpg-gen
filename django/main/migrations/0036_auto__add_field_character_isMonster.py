...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Character.isMonster'
        db.add_column('main_character', 'isMonster',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Character.isMonster'
        db.delete_column('main_character', 'isMonster')
    ...
    models = {
        ...
        'main.character': {
            ...
            'accessorySlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedAccessories'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'accessorySlot2': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedAccessories2'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            ...
            'bodySlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedBodies'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            ...
            'characterImage': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.ImageFile']", 'related_name': "'characterImages'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            ...
            'handSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedHands'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'headSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedHeads'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            ...
            'job': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Job']", 'related_name': "'characters'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '100', 'null': 'True'}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Race']", 'related_name': "'characters'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'reaction': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'null': 'True'}),
            'secondWeaponSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedSecondaryWeapons'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'related_name': "'characters'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
            'vitality': ('django.db.models.fields.IntegerField', [], {'blank': 'True', 'max_length': '3', 'null': 'True'}),
            'weaponSlot': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Item']", 'related_name': "'equippedWeapons'", 'on_delete': 'models.SET_NULL', 'null': 'True'}),
